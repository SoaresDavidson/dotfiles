...
hl.curve("linear", { type = "bezier", points = { { 0.5, 1 }, { 0.75, 1 } } })
hl.curve("almostLinear", { type = "bezier", points = { { 0.5, 1 }, { 0.75, 1 } } })
...
hl.animation({ leaf = "fade", enabled = true, speed = 1.79, bezier = "quick" })
...
hl.animation({ leaf = "zoomFactor", enabled = true, speed = 1.94, bezier = "easeOutQuint" })
