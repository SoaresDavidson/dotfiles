...
-- br-abnt2: number row emits digits directly, bind by symbol.
-- (Noctalia's default "code:N" keycode form is not parsed by the Lua bind API.)
...
for i = 1, 10 do
    hl.bind(mainMod .. " + SHIFT + " .. digitCode(i % 10), hl.dsp.window.move({ workspace = i }))
end
